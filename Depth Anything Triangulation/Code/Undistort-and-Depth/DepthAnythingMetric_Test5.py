"""
DepthAnything Test10Metricqqqq -> Metric rewrite
- Replaces relative-depth + pseudo-metric calibration with ZoeDepth metric model.
- Keeps LGNet fill, mask overlays, Open3D point cloud, mouse cursor readout, FPS.
"""
...
# ZoeDepth metric model imports (from Test4)
...
# ---------------------------
# ZoeDepth metric model wrapper (from Test4)
# ---------------------------
class ZoeMetric:
    ...
    def predict_metric(self, frame_bgr):
        ...
        # resize to model expected (use 480x640 as in Test4)
...
def main():
    ...
    ap.add_argument("--metric-model-path", type=str,
                    ...
                    help="ZoeDepth metric pretrained resource path (same format as Test4).")
    ...
    # Optional: add cylinder wireframe as reference (same as Test10)
