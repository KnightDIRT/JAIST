...
BAR_START_DISTANCE_M = 0.4   # meters to bar start (near end) actually 0.044m
BAR_END_DISTANCE_M   = 1   # meters to bar end (far end) actually 0.244m
...
PLATE_DISTANCE_M = 1    # known distance to plate (meters) actually 0.244m
