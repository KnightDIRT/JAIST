...
def main():
    ...
    try:
        ...
        while True:
            ...
            # Map display → full camera coordinates
            W_cam = float(W_full)
            H_cam = float(H_full)

            # Camera intrinsics (must match Open3D projection)
            fov_x_deg = 95.0
